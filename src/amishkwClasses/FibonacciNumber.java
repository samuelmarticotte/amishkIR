...
public class FibonacciNumber extends JFrame

{
    ...
    private final JTextArea resultsArea = new JTextArea(50, 50);
            ...
            public void actionPerformed( ActionEvent event )
                {
                    ...
                    try
                    {
                        ...
                        //SEARCH ONE QUERY
                        new Search().oneQuery(documentsDirSoph, query, results, debug, "BM25", new AnalyzerSophisticated(), outputJLabel, resultsArea);
